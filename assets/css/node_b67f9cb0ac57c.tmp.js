...
.image-container {
    position: relative;
    height: 100%; /* Usando viewport height para garantir que a imagem ocupe 90% da altura da tela */
    width: 100%;
    text-align: center;
    overflow: hidden;
}
...
@media (min-width: 1024px) {
    ...
    .img-portfolio-descktop:hover .img-overlay {
        opacity: 1;
    }

    .img-portfolio-descktop:hover img {
        transform: rotateY(180deg);
        transition: transform 1s ease-in-out;
    }

    .img-portfolio-descktop {
        position: relative;
        perspective: 100rem;
    }
